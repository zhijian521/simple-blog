 ...
 * 当雪花超出边界时，重置到顶部重新进入
 */
export function updateSnowflakes(snowflakes: Snowflake[], canvasWidth: number, canvasHeight: number): void {
 ...
 * 初始化指定数量的雪花
 */
export function initializeSnowflakes(count: number, canvasWidth: number, canvasHeight: number): Snowflake[] {
