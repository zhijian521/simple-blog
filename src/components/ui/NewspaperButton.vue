...
.newspaper-button {
    position: fixed;
    top: var(--spacing-lg);
    right: calc(var(--spacing-lg) + 48px); /* 搜索按钮左侧，40px 宽度 + 8px 间距 */
    display: flex;
    align-items: center;
...
@media (max-width: 768px) {
    .newspaper-button {
        top: var(--spacing-md);
        right: calc(var(--spacing-md) + 44px); /* 搜索按钮左侧，36px 宽度 + 8px 间距 */
        width: 36px;
        height: 36px;
    }
